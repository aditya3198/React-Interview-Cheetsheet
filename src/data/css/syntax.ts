...
const cssSyntax: SyntaxEntry[] = [
  {
    id: 'flexbox',
    title: 'Flexbox',
    description: 'One-dimensional layout system for distributing space and aligning items in a row or column.',
    language: 'css',
...
.parent {
  ...
  },
  {
    ...
    description: 'Smoothly interpolate property changes between states.',
    language: 'css',
...
/* ease | linear | ease-in | ease-out | ease-in-out | cubic-bezier() */`,
  },
  {
    id: 'media-queries',
    title: 'Media Queries',
    description: 'Apply styles conditionally based on viewport size, orientation, or device capabilities.',
    language: 'css',
...
@media print {
  ...
  },
  {
    ...
    description: 'Define reusable values with --name syntax, accessed via var(). Live in the cascade and inherit.',
    language: 'css',
...
.main    { grid-area: main; }`,
  },
  {
    ...
    description: 'Translate, rotate, scale, and skew elements without affecting document flow.',
    language: 'css',
...
/* Avoid animating: width, height, top, left, box-shadow */`,
  },
  {
    ...
    description: 'Declarative multi-step animations with @keyframes and the animation shorthand.',
    language: 'css',
...
@media (prefers-reduced-motion: reduce) {
  ...
  },
  {
    ...
    description: '::before and ::after insert generated content; other pseudo-elements target specific parts of elements.',
    language: 'css',
...
li::marker { color: var(--color-primary); }`,
  },
  {
    id: 'aspect-ratio',
    title: 'aspect-ratio',
    description: 'Maintain a specific width-to-height ratio without padding hacks.',
    language: 'css',
...
.old-way > * {
  ...
  },
  {
    id: 'clamp-min-max',
    title: 'clamp(), min(), max()',
    description: 'Fluid sizing functions that adapt between fixed bounds without media queries.',
    language: 'css',
...
.section {
  ...
  },
  {
    ...
    description: ':is(), :where(), :has(), and :not() for powerful selector composition.',
    language: 'css',
...
button:focus-visible { outline: 2px solid var(--color-primary); }`,
  },
  {
    id: 'clip-path',
    title: 'clip-path',
    description: 'Mask elements to arbitrary shapes: circles, polygons, ellipses, or SVG paths.',
    language: 'css',
...
.reveal.visible {
  ...
  },
  {
    ...
    description: 'Flow-relative properties that work correctly in both LTR and RTL text directions.',
    language: 'css',
...
.el {
  ...
  },
  {
    ...
    description: 'Style elements based on their container\'s size rather than the viewport.',
    language: 'css',
...
.card-img {
  ...
  },
  {
    ...
    description: 'Organize styles into named layers with explicit priority, removing specificity battles.',
    language: 'css',
...
@import url("bootstrap.css") layer(third-party);`,
  },
  {
    id: 'subgrid',
    title: 'CSS Subgrid',
    description: 'Nested grids that inherit parent\'s track definitions for precise alignment.',
    language: 'css',
...
.card-footer { grid-row: 3; } /* always row 3 — aligned at bottom */`,
  },
  {
    ...
    description: 'Register typed CSS custom properties with syntax, initial value, and inheritance control.',
    language: 'css',
