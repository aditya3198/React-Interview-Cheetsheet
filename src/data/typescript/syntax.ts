...
const tsSyntax: SyntaxEntry[] = [
  {
    ...
    description: 'Annotate variables, parameters, and return types with a colon suffix.',
    language: 'typescript',
...
const y = [1, 2, 3];  // inferred: number[]`,
  },
  {
    id: 'ts-interfaces',
    title: 'Interfaces',
    description: 'Named structural contracts describing the shape of objects and classes.',
    language: 'typescript',
...
interface Comparator<T> {
  ...
  },
  {
    id: 'ts-type-aliases',
    title: 'Type Aliases',
    description: 'Name any type — primitives, unions, intersections, objects, functions, and complex generics.',
    language: 'typescript',
...
const isEven: Predicate<number> = (n) => n % 2 === 0;`,
  },
  {
    id: 'ts-union-types',
    title: 'Union Types',
    description: 'A value that can be one of several types — use type guards to work with each member.',
    language: 'typescript',
...
type NonNulls  = NonNullable<string | null | undefined>;     // string`,
  },
  {
    ...
    description: 'Combine multiple types — the resulting type has all properties of every member.',
    language: 'typescript',
...
type ButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  },
  {
    id: 'ts-enums',
    title: 'Enums',
    description: 'Named sets of numeric or string constants — const enum inlines values at compile time.',
    language: 'typescript',
...
type Role = 'admin' | 'user' | 'guest';`,
  },
  {
    id: 'ts-tuple-types',
    title: 'Tuple Types',
    description: 'Fixed-length arrays with a known type at each position.',
    language: 'typescript',
    tags: ['tuples', 'arrays'],
    tier: 'core',
    level: 'fresher',
...
const [isOpen, toggle] = useToggle();`,
  },
  {
    ...
    description: 'Override inferred types when you know more than the compiler — use as sparingly as possible.',
    language: 'typescript',
...
function isUser(val: unknown): val is User {
  ...
  },
  {
    id: 'ts-generics',
    title: 'Generics',
    description: 'Parameterize functions, interfaces, and classes over types they operate on.',
    language: 'typescript',
...
zip([1, 2], ['a', 'b']); // [[1,'a'], [2,'b']]`,
  },
  {
    ...
    description: 'Limit what types a type parameter can be with extends — access only guaranteed properties.',
    language: 'typescript',
...
const c2: Container<number> = { value: 42 };`,
  },
  {
    ...
    description: 'keyof extracts a union of property keys; typeof captures the type of a runtime value.',
    language: 'typescript',
...
type Route = (typeof ROUTES)[keyof typeof ROUTES]; // '/' | '/about' | '/contact'`,
  },
  {
    ...
    description: 'Look up the type of a property using T[K] — extract types from nested structures.',
    language: 'typescript',
...
// { readonly path: '/'; readonly component: 'Home' }`,
  },
  {
    ...
    description: 'Partial, Required, Readonly, Record, Pick, and Omit — reshape object types without repetition.',
    language: 'typescript',
...
type PublicUser = Omit<User, 'email' | 'role'>;`,
  },
  {
    ...
    description: 'Exclude, Extract, NonNullable, ReturnType, Parameters, and Awaited.',
    language: 'typescript',
...
type Data = Awaited<ReturnType<typeof fetchData>>; // { id: number }`,
  },
  {
    id: 'ts-type-guards',
    title: 'Type Guards',
    description: 'Narrow a union to a specific member using built-in or user-defined guards.',
    language: 'typescript',
...
const users = values.filter(isUser); // User[]`,
  },
  {
    ...
    description: 'A union with a shared literal tag property enabling exhaustive, type-safe branching.',
    language: 'typescript',
...
function render<T>(result: Result<T>): string {
  ...
  },
  {
    id: 'ts-mapped-types',
    title: 'Mapped Types',
    description: 'Iterate over the keys of a type and transform each property — the basis of all built-in utility types.',
    language: 'typescript',
...
// { a: string; c: string }`,
  },
  {
    ...
    description: 'Branch type logic with T extends U ? A : B — distributes over union members by default.',
    language: 'typescript',
...
type G = Flatten<string[]>; // string`,
  },
  {
    ...
    description: 'Capture and name a matched sub-type inside a conditional type.',
    language: 'typescript',
...
type NewableReturn<T> =
  ...
  },
  {
    ...
    description: 'Construct new string literal types using template syntax — distributes over union members.',
    language: 'typescript',
...
type Id = ExtractId<'user_abc123'>; // 'abc123'`,
  },
  {
    ...
    description: 'TypeScript adds access modifiers, readonly, abstract, and override to JavaScript classes.',
    language: 'typescript',
...
// equivalent to: class Point { readonly x; readonly y; constructor(x,y) {...} }`,
  },
  {
    ...
    description: 'Define a base class with methods subclasses must implement — cannot be instantiated directly.',
    language: 'typescript',
...
shapes.forEach(s => console.log(s.describe()));`,
  },
  {
    ...
    description: 'Declare multiple call signatures to express type-level polymorphism for a single function.',
    language: 'typescript',
...
class EventBus {
  ...
  },
  {
    id: 'ts-as-const',
    title: 'as const',
    description: 'Infer the narrowest possible literal type and make the value readonly throughout.',
    language: 'typescript',
...
// 'pending' | 'active' | 'inactive'`,
  },
  {
    ...
    description: 'Validate a value against a type without widening its inferred literal types.',
    language: 'typescript',
...
palette.red.map(c => c / 255); // OK`,
  },
  {
    ...
    description: 'Describe objects with dynamic string or number keys.',
    language: 'typescript',
...
type Cache = Record<string, { value: unknown; expiresAt: number }>;`,
  },
  {
    ...
    description: 'Explicit resource management — automatically dispose resources when they leave scope.',
    language: 'typescript',
...
async function processFile() {
  ...
  },
  {
    ...
    description: 'Extend third-party module types or add to the global scope without touching their source.',
    language: 'typescript',
...
declare module '*.svg' { const url: string; export default url; }`,
  },
  {
    ...
    description: 'Declarative annotations that augment classes, methods, fields, and accessors.',
    language: 'typescript',
...
class Counter {
  ...
  },
  {
    ...
    description: 'Infer literal types in generic functions without requiring as const at every call site.',
    language: 'typescript',
...
// routes[0].path: '/'  — literal, not just string`,
  },
  {
    ...
    description: 'Types that reference themselves — useful for trees, JSON, deeply nested structures.',
    language: 'typescript',
...
// config.db.host is readonly — nested too`,
  },
  {
    ...
    description: 'Prevent TypeScript from using a specific argument to infer a type parameter.',
    language: 'typescript',
...
const n = withDefault<number>(undefined, 0); // fallback must be number`,
  },
  {
    ...
    description: 'Functions that communicate type information back to the caller for narrowing.',
    language: 'typescript',
